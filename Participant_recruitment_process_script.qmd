...
The purpose of this script is to assist in undertaking second rounds of recruitment in our project with the overall title "Safer gambling: Identifying and supporting at-risk consumers". The OSF page for this project can be found [here](https://osf.io/5at3q/) (it's currently a private project as of the latest date this file was committed). We plan to work with a online wagering operator who will send survey links to their customers in recruitment messages. If we do not achieve our ideal sample size of 1500 participants after the first round of messages are sent, we will undertake two further rounds of recruitment messaging.
...
We will remove all participants who have opened the survey in the first round of recruitment from the recruitment list using the R code. Below we include some code that demonstrates how we will achieve this for illustrative purposes (it will be included in our preregistration).
...
# Now use these dummy customer IDs to create anexample recruitment list:
